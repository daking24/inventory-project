        ...
        <table class="table">
            ...
            <tr>
                ...
                <div class="d-flex align-items-center justify-content-end">
                    <button class="btn btn-sm btn-icon btn-icon-start btn-outline-info ms-1" type="button">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <select id="sender_method" name="sender_method" class="form-control form-select">
                ...
                <div class="mb-3">
                    ...
                    <select id="receiver_method" name="receiver_method" class="form-control form-select">
                        <option selected="">Choose...</option>
                        <option>...</option>
                    </select>
                </div>
