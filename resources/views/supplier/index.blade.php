        ...
        <table class="table">
            ...
            <tr>
                ...
                <div class="d-flex align-items-center justify-content-end">
                    <a href="{{ route('supplier-view') }}" type="button" class="btn btn-sm btn-icon btn-icon-start btn-outline-info ms-1" >
                    ...
                    <button data-bs-toggle="modal" data-bs-target="#editSupplier"
