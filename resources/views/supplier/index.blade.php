...
<div class="page-title-container">
    <div class="row">
        ...
        <div class="col-12 col-sm-6 d-flex align-items-start justify-content-end">
                    <!-- Tour Button Start -->
            <a type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#addSupplier">Register Supplier</a>
        ...
        <table class="table">
            ...
            <tr>
                ...
                <div class="d-flex align-items-center justify-content-end">
                    <a href="{{ route('supplier-view', $item->id) }}" type="button" class="btn btn-sm btn-icon btn-icon-start btn-outline-info ms-1" >
                    ...
                    <a href="#" data-bs-toggle="modal" data-bs-target="#editSupplier"
