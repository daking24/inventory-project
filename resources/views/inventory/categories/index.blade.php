@extends('layouts.app', ['pageSlug' => 'inventory_categories', 'page' => 'Inventory | Categories', 'section' => ''])

@section('content')
<div class="page-title-container">
    <div class="row">
        <div class="col-12 col-sm-6">
            <h1 class="mb-0 pb-0 display-4">Categories</h1>
        </div>
        <div class="col-12 col-sm-6 d-flex align-items-start justify-content-end">
                    <!-- Tour Button Start -->
            <a type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#createCategory">Register Category</a>
    ...
    <div class="card-body">
        ...
        <table class="table">
            ...
            <tr>
                ...
                <td>{{ $item->products->sum('stock_defective') }}</td>
                <td>{{ __($item->products->avg('selling_price')) }}</td>
                {{-- <td>{{ dd($item->products) }}</td> --}}
                <td>
                <div class="d-flex align-items-center justify-content-end">
                    <a href="{{ route('category-view', $item->id) }}"  type="button" class="btn btn-sm btn-icon btn-icon-start btn-outline-info ms-1" >
                    ...
                    <button data-bs-toggle="modal" data-bs-target="#editCategory" class="btn btn-sm btn-icon btn-icon-start btn-outline-info ms-1" type="button">
                    ...
                    <a href="#" data-bs-toggle="modal" data-bs-target="#deleteCategory" class="btn btn-sm btn-icon btn-icon-start btn-outline-danger ms-1" type="button">
...
{{-- Create Client Modal --}}
@include('inventory.categories.modal.create')
@include('inventory.categories.modal.edit')
@include('inventory.categories.modal.delete')
@endsection
