  ...
  <div class="page-title-container">
    <div class="row">
      ...
      <div class="col-12 col-sm-6 d-flex align-items-start justify-content-end">
        <!-- Tour Button Start -->
        <a type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#createCategory">Register
          Category</a>
            ...
            <tr>
              ...
              <td>
                <div class="d-flex align-items-center justify-content-end">
                  <a href="{{ route('category-view', $item->id) }}" type="button"
                  ...
                  <button data-bs-toggle="modal" data-bs-target="#editCategory{{ $item->id }}"
                  ...
                  <a href="#" data-bs-toggle="modal" data-bs-target="#deleteCategory{{ $item->id }}"
