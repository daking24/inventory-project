              ...
              <tr>
                ...
                <td>
                  ...
                  <div class="d-flex align-items-center justify-content-end">
                    <a href="{{ route('sales-view', $sold->sale_id) }}" type="button" class="btn btn-sm btn-icon btn-icon-start btn-outline-info ms-1">
          ...
          <tbody>
            ...
            @foreach ($receiveds as $received)
              <tr>
                ...
                <td><a href="{{ route('receipt-view', $received->receipt) }}">{{ $received->receipt_id }}</a></td>
                ...
                <td>
                  <div class="d-flex align-items-center justify-content-end">
                    <a href="{{ route('receipt-view', $received->receipt) }}" type="button"
