        ...
        <table class="table">
            ...
            <tr>
                ...
                <div class="d-flex align-items-center justify-content-end">
                    ...
                    <a href= "{{ route('products.edit', $item->id) }}" data-bs-toggle="modal" data-bs-target="#editProduct{{ $item->id }}" class="btn btn-sm btn-icon btn-icon-start btn-outline-info ms-1" type="button">
                    ...
                    <a href="#" data-bs-toggle="modal" data-bs-target="#deleteProduct{{ $item->id }}" class="btn btn-sm btn-icon btn-icon-start btn-outline-danger ms-1" type="button">
