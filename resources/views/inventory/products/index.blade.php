  ...
  <div class="page-title-container">
    <div class="row">
      ...
      <div class="col-12 col-sm-6 d-flex align-items-start gap-1 justify-content-end">
        <!-- Tour Button Start -->
        <a type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#createProduct">Register
          Product</a>
            ...
            <tr>
              ...
              <td>
                <div class="d-flex align-items-center justify-content-end">
                  <a href="{{ route('product-view', $item->id) }}" type="button"
                  ...
                  <a href="{{ route('products.edit', $item->id) }}" data-bs-toggle="modal"
                    ...
                    <a href="#" data-bs-toggle="modal" data-bs-target="#deleteProduct{{ $item->id }}"
