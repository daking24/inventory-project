            ...
            <tbody>
                ...
                <div class="d-flex align-items-center justify-content-end">
                    ...
                    @if($receipt->finalized_at)
                            <a href="{{ route('receipt-view', ['receipt' => $receipt]) }}" type="button" class="btn btn-sm btn-icon btn-icon-start btn-outline-info ms-1" >
