@extends('layouts.app', ['pageSlug' => 'payment_methods', 'page' => 'Payment Methods', 'section' => ''])

@section('content')
<div class="page-title-container">
    <div class="row">
        <div class="col-12 col-sm-6">
            <h1 class="mb-0 pb-0 display-4">Bank Accounts/Payment Method</h1>
        </div>
        <div class="col-12 col-sm-6 d-flex align-items-start justify-content-end">
                    <!-- Tour Button Start -->
            <a type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#addMethod">Add Method</a>
        ...
        <table class="table">
            ...
            @forelse ($methods as $method)
                <tr>
                    ...
                    <td>₦{{ __($method->transactions->sum('amount')) }}</td>
                    <td>
                        <div class="d-flex align-items-center justify-content-end">
                    <a href="{{ route('method-view', $method) }}" type="button" class="btn btn-sm btn-icon btn-icon-start btn-outline-info ms-1" >
                    ...
                    <a href="#" data-bs-toggle="modal" data-bs-target="#editMethod{{ $method->id }}"
                    ...
                    <a href="#" data-bs-toggle="modal" data-bs-target="#deleteMethod{{ $method->id }}" class="btn btn-sm btn-icon btn-icon-start btn-outline-danger ms-1" type="button">
...
@include('payment-methods.modal.edit')
@include('payment-methods.modal.delete')
                @empty
                <tr>
...
{{-- Create Client Modal --}}
@include('payment-methods.modal.create')
@endsection
