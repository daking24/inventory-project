          ...
          <tr>
            ...
            <td>
              <div class="d-flex align-items-center justify-content-end">
                ...
                <a href="#" data-bs-toggle="modal" data-bs-target="#deleteMethod{{ $method->id }}"
          ...
          <tr>
            <td colspan="6" class="text-center">
              <div class="text-center">
                <span class="text-warning">There is no data to display</span>
              </div>
            </td>
          </tr>
          @endforelse
