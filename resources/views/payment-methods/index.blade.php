        ...
        <table class="table">
            ...
            @forelse ($methods as $method)
                <tr>
                    ...
                    <a href="#" data-bs-toggle="modal" data-bs-target="#editMethod"
                    ...
                    <a href="#" data-bs-toggle="modal" data-bs-target="#deleteMethod" class="btn btn-sm btn-icon btn-icon-start btn-outline-danger ms-1" type="button">
