    ...
    <div class="card-body">
        ...
        <table class="table">
            ...
            <tr>
                ...
                <td>pay through bank</td>
                <td>10</td>
                <td>20000000</td>
                <td>
                <div class="d-flex align-items-center justify-content-end">
                    <a href="{{ route('method-view') }}" type="button" class="btn btn-sm btn-icon btn-icon-start btn-outline-info ms-1" >
                    ...
                    <button data-bs-toggle="modal" data-bs-target="#editMethod"
