                    ...
                    <tr>
                        ...
                        <td class="td-actions text-right">
                            ...
                            @if ($transaction->sale_id)
                                <a href="{{ route('sales-view', $transaction->sale) }}" type="button" class="btn btn-sm btn-icon btn-icon-start btn-outline-info ms-1" >
                            ...
                            @else
                                ...
                                <a href="#" data-bs-toggle="modal" data-bs-target="#transactionEdit"
                                ...
                                <a href="#" data-bs-toggle="modal" data-bs-target="#tansactionDelete" class="btn btn-sm btn-icon btn-icon-start btn-outline-danger ms-1" type="button">
...
@include('payment-methods.modal.transaction_delete')
