    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form class="mb-3" action="{{ route('sales.product.store', $sale) }}" method="post">
          ...
          <div class="form-floating mb-3">
            <input id="product-price" type="number" class="form-control form-control-alternative"
              placeholder="Selling Price" name="unit_price" value="0" readonly>
          ...
          <div class="form-floating mb-3">
            <input id="input-total" type="text" class="form-control form-control-alternative"
              placeholder="Total Amount" name="total_amount" value="0" readonly>
