...
<div class="page-title-container">
    <div class="row">
        ...
        <div class="col-12 col-sm-6 d-flex align-items-start justify-content-end">
                    <!-- Tour Button Start -->
            <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#saleRegister">Register Sale</button>
            <!-- Tour Button End -->
        </div>
    </div>
</div>
...
<div class="modal modal-right large fade" id="saleRegister" tabindex="-1" role="dialog" aria-hidden="true">
