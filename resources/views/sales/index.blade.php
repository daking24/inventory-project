  ...
  <div class="page-title-container">
    <div class="row">
      <div class="col-12 col-sm-6">
        <h1 class="mb-0 pb-0 display-4">Sales</h1>
      </div>
      <div class="col-12 col-sm-6 d-flex align-items-start justify-content-end">
        <!-- Tour Button Start -->
        <a type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#createClient">Register
          Sale</a>
            ...
            <tr>
              ...
              <td>
                <div class="d-flex align-items-center justify-content-end">
                  @if (!$sale->finalized_at)
                    <a href="{{ route('sales.product.create', ['sale' => $sale]) }}"
                  ...
                  @else
                    <a href="{{ route('sales-view', ['sale' => $sale]) }}" type="button"
                  ...
                  @role('Admin Manager')
                    <button class="btn btn-sm btn-icon btn-icon-start btn-outline-danger ms-1" data-bs-toggle="modal"
                      data-bs-target="#deleteSale{{ $sale->id }}" type="button">
                      <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 20 20"
                        fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
