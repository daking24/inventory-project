...
<div class="container">
                    ...
                    <div class="page-title-container">
                        <div class="row">
                            ...
                            <!-- Top Buttons Start -->
                            <div
                                class="col-12 col-sm-6 d-flex align-items-start justify-content-end"
                            >
                                <!-- Tour Button Start -->
                                <button
                                    type="button"
                    ...
                    <div class="row">
                        <div class="col-12 col-xl-6">
                            ...
                            >
                                ...
                                <div class="card mb-2 h-auto sh-xl-24">
                                    <div class="card-body">
                                        <div
                                            class="row g-0 h-100 chart-container"
                                        >
                                            ...
                                            >
                                                ...
                                                <div>
                                                    <div>
                                                        ...
                                                        ></div>
                                                        <i
                                                            class="icon d-inline-block align-middle text-primary"
                                                            data-acorn-size="15"
                                                        ></i>
                                                    </div>
                                                    <div
                                                        class="text-small text-muted mb-1 text"
                                                    ></div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-auto">
                                                        <div
                                                            class="cta-3 text-alternate"
                                                        >
                                                            84
                                                        </div>
                                                        <div
                                                            class="text-small text-muted mb-1"
                                                        >
                                                            THIS WEEK
                                                        </div>
                                                    </div>
                                        ...
                                        >
                                            <div class="glide__slides">
                                                <div class="glide__slide">
                                                    <div
                                                        class="card mb-5 sh-20 hover-border-primary"
                                                    >
                                                        <div
                        ...
                        <div class="col-12 col-xl-6 mb-5">
                            <div class="d-flex justify-content-between">
                                ...
                                <div
                                    class="dropdown-menu dropdown-menu-sm dropdown-menu-end shadow"
                                >
                                ...
                                <div class="scroll-by-count" data-count="6">
                                    ...
                                    >
                                        <div class="row g-0 sh-12">
                                            <div class="col-auto">
                                                <a
                                                    href="../Pages/Portfolio/Detail.html"
                                                >
                                                    <img
                                                ...
                                                >
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                            <div
                                                                class="text-small text-muted text-truncate"
                                                            >
                                                                Icing liquorice
                                                                olegário jujubes
                                                                oat cake.
                                    ...
                                    <div class="card mb-2">
                                        <div class="row g-0 sh-12">
                                            ...
                                            >
                                                <span
                                                    class="badge rounded-pill bg-primary me-1 position-absolute e-n3 t-2"
                                                    >TREND</span
                                                >
                                                <a
                                                    href="../Pages/Portfolio/Detail.html"
                                        ...
                                        <div class="row g-0 mb-2">
                                            ...
                                            <div class="col">
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <div
                                                            class="text-alternate mt-n1 lh-1-25"
                                                        >
                                                            New user
                                                            registiration
                                                        </div>
                                            ...
                                            <div class="col-auto">
                                                ...
                                                >
                                                    <div
                                                        class="text-muted ms-2 mt-n1 lh-1-25"
                                                    >
                                                        18 Dec
                                                    </div>
                                                </div>
                                                ...
                                                >
                                                    <div class="sh-3">
                                                        <i
                                                            ...
                                                            class="text-secondary align-top"
                                                        ></i>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                >
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            ...
                                                            <a
                                                                href="#"
                                                                class="alternate-link underline-link"
                                                                >Breadstick</a
                                                            >
                                                        </div>
                                                    </div>
                                ...
                                >
                                    <div class="card h-100 hover-scale-up">
                                        ...
                                        >
                                            ...
                                            <div
                                                class="text-extra-small fw-medium text-muted"
                                            >
                                                14 PRODUCTS
                                            </div>
                                        </a>
                    ...
                    <div class="row">
                        <div class="col-12 col-md-4 mb-5">
                            <div
                                class="card w-100 sh-18 sh-md-22 hover-img-scale-up"
                            >
                                <img
                    ...
                    <div class="row gy-5">
                            ...
                            <div class="card h-100-card">
                                <div class="card-body">
                                    ...
                                    <div class="text-muted mb-4">
                                        ...
                                        drops. Brownie ice cream marshmallow
                                        topping.
                                    </div>
                                    <form>
                                        <div class="mb-3 filled w-100">
                                            ...
                                            <select
                                                class="select-single-no-search-filled select2-hidden-accessible"
                                                id="categorySelect"
                                        ...
                                        <a
                                            href="#"
                                            class="btn btn-icon btn-icon-start btn-primary mt-3"
                                        >
                                            <i
                                                data-acorn-icon="chevron-right"
                                            ></i>
                        ...
                        <div class="col-12 col-xl-8">
                            ...
                            <div
                                class="card h-100-card sh-md-45 bg-transparent"
                            >
                                <video
                                    class="player cover"
